...
import { ArrowRight, CheckCircle, Calendar, Play, Phone } from 'lucide-react';
        ...
        <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold text-gray-900 leading-tight">
                Stop Chasing.<br />
                <span className="whitespace-nowrap">Start Hiring Smarter.</span>
              </h1>
            ...
            <div className="relative">
              <div 
                className="relative bg-gray-900 rounded-xl overflow-hidden cursor-pointer group shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105 max-w-2xl mx-auto"
